...
fn cli_help_snapshots_cover_all_commands() {
    let cases: &[(&str, &[&str])] = &[
        ...
        (
            ...
            &["tasks", "suggest-list", "--help"],
        ),
        ("cli_help_tasks_complete", &["tasks", "complete", "--help"]),
        ("cli_help_tasks_reopen", &["tasks", "reopen", "--help"]),
        ("cli_help_tasks_edit", &["tasks", "edit", "--help"]),
        ("cli_help_tasks_move", &["tasks", "move", "--help"]),
        ("cli_help_tasks_delete", &["tasks", "delete", "--help"]),
        ("cli_help_tasks_links", &["tasks", "links", "--help"]),
        ("cli_help_tasks_open", &["tasks", "open", "--help"]),
        ("cli_help_steps", &["steps", "--help"]),
        ("cli_help_steps_list", &["steps", "list", "--help"]),
        ("cli_help_steps_add", &["steps", "add", "--help"]),
        ("cli_help_steps_edit", &["steps", "edit", "--help"]),
        ("cli_help_steps_check", &["steps", "check", "--help"]),
        ("cli_help_steps_uncheck", &["steps", "uncheck", "--help"]),
        ("cli_help_steps_delete", &["steps", "delete", "--help"]),
        ("cli_help_links", &["links", "--help"]),
        ("cli_help_links_list", &["links", "list", "--help"]),
        ("cli_help_links_add", &["links", "add", "--help"]),
        ("cli_help_links_edit", &["links", "edit", "--help"]),
        ("cli_help_links_delete", &["links", "delete", "--help"]),
        ...
        (
            "cli_help_attachments_add",
            &["attachments", "add", "--help"],
        ),
        (
        ...
        ("cli_help_myday_remove", &["myday", "remove", "--help"]),
        ("cli_help_myday_suggest", &["myday", "suggest", "--help"]),
